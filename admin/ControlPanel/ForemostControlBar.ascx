<%@ Control Language="C#" AutoEventWireup="false" Inherits="DotNetNuke.UI.ControlPanels.ControlBar"
    CodeFile="ForemostControlBar.ascx.cs" %>
    ...
    <div id="ControlBar">
        <div class="ControlContainer">
            <div class="ServiceIcon professional">
				<a href="https://www.foremostmedia.com/support" target="_blank"><img id="ControlBar_conrolbar_logo" src="/admin/ControlPanel/ForemostMedia/foremost.png" alt="Foremost Media" style="display: inline;"></a>     
            </div>
            <!-- close ServiceIcon -->
            <ul id="ControlNav">
                ...
                <li class="controlBar_ArrowMenu"><a href="javascript:void(0)">
                    ...
                    <div class="subNav">
                        <dl>
                            <dd>
                                <ul> <% if (DotNetNuke.Security.PortalSecurity.IsInRole("Administrators"))
                                       {%>
                                        <li><a href="https://www.foremostmedia.com/resources/support" target="_blank">Online Help</a></li><li><a href="https://www.foremostmedia.com/resources/support/submit-a-ticket" target="_blank">Submit A Ticket</a></li><li><a href="https://www.foremostmedia.com/contact/pay-invoices-online" target="_blank">Pay Invoice</a></li>
                                    <% } %>
                                </ul>
                            </dd>
                        </dl>
