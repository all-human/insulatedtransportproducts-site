		...
		<div class="main_content">
			<div class="tabbed_container">
				<asp:Panel ID="pnlRssImport" runat="server">
					<div class="content">
						<asp:Panel ID="pnlRssImportHeader" runat="server">
							<div class="main_content gridview_content_manager tag_editor" style="padding: 0;">
								<div class="content_wrapper">
									<asp:GridView ID="gvFeeds" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="0" DataSourceID="odsFeeds" EnableModelValidation="True" GridLines="None" ShowFooter="True" DataKeyNames="RSSID" OnRowCommand="gvFeeds_RowCommand"
										CssClass="grid_view_table">
										<AlternatingRowStyle CssClass="second edgrow" />
										<Columns>
											<asp:TemplateField ShowHeader="False">
												<ItemTemplate>
													<asp:LinkButton ID="lbEditRSS" runat="server" CausesValidation="False" CommandArgument='<%# Eval("RSSID") %>' CommandName="EditRSS" CssClass="action_set pair edit" ToolTip="<%#EditText%>"></asp:LinkButton>
													<asp:LinkButton ID="lbDeleteRSS" runat="server" CausesValidation="False" CommandName="Delete" CssClass="action_set pair delete" OnClientClick="return ConfirmDelete();" ToolTip="<%#Delete%>"></asp:LinkButton>
													<asp:LinkButton ID="lbDeleteAllMediaByFees" runat="server" resourcekey="lbDeleteAllMediaByFees" CausesValidation="False" CommandArgument='<%# Eval("RSSID") %>' CommandName="DeleteMediaByFeed" OnClientClick="return ConfirmDelete();" Style="clear: both; margin-top: 0; padding: 0; font-size: 10px; display: block;"
														Text="Delete all media added by this feed"></asp:LinkButton>
												</ItemTemplate>
						...
						<asp:Panel ID="pnlAddRSSImport" CssClass="section_box grey white_border_1" runat="server">
										...
										<table class="style1">
											<tr>
												...
												<td>
													...
													<asp:RegularExpressionValidator ID="revFeedURL" runat="server" ControlToValidate="tbFeedURL" Display="Dynamic" ErrorMessage="Please enter valid URL." ValidationExpression="http(s)?://?" ValidationGroup="vgRSSImport" resourcekey="revFeedURLResource1.ErrorMessage"
											...
											<tr>
												...
												<td>
													...
													<asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="ddlSelectGalleryToImportTo" Display="Dynamic" ErrorMessage="Please select gallery" Operator="NotEqual" ValidationGroup="vgRSSImport" ValueToCompare="0"></asp:CompareValidator>
												</td>
											</tr>
											<tr>
												<td class="style3">
												...
												<td>
													<asp:CheckBox ID="cbUseTitle" runat="server" Checked="True" />
												</td>
											</tr>
											<tr>
												<td class="style3">
												...
												<td>
													<asp:CheckBox ID="cbUseDescription" runat="server" Checked="True" />
												</td>
											</tr>
											<tr>
												<td class="style3">
													<dnn:Label ID="lblLimitNumberofMedia" runat="server" Text="Limit number of media:" HelpText="Enter the limit of media number to be stored for this feed. If number of media from the feed is greater than entered number older media will be deleted. Enter 0 to store all media."
														HelpKey="lblLimitNumberofMedia.HelpText" ResourceKey="lblLimitNumberofMedia"></dnn:Label>
												</td>
												<td>
													<asp:TextBox ID="tbLimitNumberofMedia" runat="server" CssClass="text" Width="50px">0</asp:TextBox>
													<asp:RequiredFieldValidator ID="rfvLimitContent" runat="server" ControlToValidate="tbLimitNumberofMedia" Display="Dynamic" ErrorMessage="Please enter media limit number." ValidationGroup="vgRSSImport" resourcekey="rfvLimitContentResource1.ErrorMessage"></asp:RequiredFieldValidator>
													<asp:CompareValidator ID="cvLimitNumberOfMedia" runat="server" ControlToValidate="tbLimitNumberofMedia" Display="Dynamic" ErrorMessage="Please enter number. " Operator="DataTypeCheck" SetFocusOnError="True" Type="Integer" ValidationGroup="vgRSSImport"></asp:CompareValidator>
												</td>
											</tr>
											<tr>
												<td class="style3">
												...
												<td>
													...
													<asp:RequiredFieldValidator ID="rfvLimitContent0" runat="server" ControlToValidate="tbLimitImportIntoSummary" Display="Dynamic" ErrorMessage="Please enter media limit number." resourcekey="rfvLimitContentResource1.ErrorMessage" ValidationGroup="vgRSSImport"></asp:RequiredFieldValidator>
													<asp:CompareValidator ID="cvLimitMediaSummary" runat="server" ControlToValidate="tbLimitImportIntoSummary" Display="Dynamic" ErrorMessage="Please enter number. " Operator="DataTypeCheck" SetFocusOnError="True" Type="Integer" ValidationGroup="vgRSSImport"></asp:CompareValidator>
												</td>
											</tr>
											<tr>
												<td class="style3">
											...
											<tr id="trImportYouTubeStats" runat="server" visible="false">
												...
												<td>
													<asp:CheckBox ID="cbImportYouTubeStats" runat="server" Checked="False" />
												</td>
											</tr>
											<tr id="trDownloadEnclosureMedia" runat="server" visible="true">
												...
												<td>
													<asp:CheckBox ID="cbDownloadEnclosureMedia" runat="server" Checked="False" />
												</td>
											</tr>
											<tr>
												<td class="style3">&nbsp;
