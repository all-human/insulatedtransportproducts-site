...
function portfoliopro_LoadMoreMediaData(PortalID, ModuleID) {
	...
	if (requestInProgress == false) {
		eds1_10.ajax({
			...
			url: "/DesktopModules/EasyDNNGallery/Services/PortfolioProLoadMediaHtmlData.ashx?portalid=" + PortalID + "&emodule=" + ModuleID,
