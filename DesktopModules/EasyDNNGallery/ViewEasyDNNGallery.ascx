...
<asp:Label ID="lblMainMessage" runat="server" Text="Please add some images then setup gallery." Visible="False" resourcekey="lblMainMessageResource1"></asp:Label>
...
<div id="<%=strMduleID%>EasyDNNGallery">
