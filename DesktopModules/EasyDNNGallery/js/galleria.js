...
Galleria = function() {
    ...
    var carousel = this._carousel = {
        ...
        update: function() {
            ...
            // TiiiiiiiiiiOiiiiiiiiiiiiiDO: fix so the carousel moves to the left
        },
    ...
    var tooltip = this._tooltip = {
        ...
        bind: function( elem, value ) {
            ...
            // TiiiiiiiiiiOiiiiiiiiiiiiiDO: revise if alternative tooltip is needed for mobile devices
            if (Galleria.TOUCH) {
                return;
            }
...
Galleria.prototype = {
                    ...
                    complete: function( thumb ) {
                        ...
                        $.each(arr, function( i, measure ) {
                            ...
                            if ( (o.thumbCrop !== true || o.thumbCrop === m ) ) {
                                ...
                                css = {};
                                css[ top[ i ] ] = 0;
                                $( thumb.image ).css( css ).attr('alt', $(thumb.container).data('alt'));
                            }
    ...
    */
    ...
    validate : function( data ) {
        // TiiiiiiiiiiOiiiiiiiiiiiiiDO: validate a custom data array
        return true;
    },
...
$(document).mousemove(function(e) {
    ...
    */
    ...
    removePan: function() {
        ...
        // TiiiiiiiiiiOiiiiiiiiiiiiiDO: doublecheck IE8
...
this.prependChild( 'info', 'myElement' );
    ...
    */
    ...
    _show : function() {
        ...
        next.load( src, function( next ) {
            ...
            self._scaleImage( next, {
                ...
                complete: function( next ) {
                    ...
                    // TiiiiiiiiiiOiiiiiiiiiiiiiDO: rethink if this is necessary
                    self.removePan();
        ...
        $(next.image).attr('alt', data.description);
    },
