...
<div id="EDGadmin">
	<div class="module_action_title_box">
		...
		<h1>
			<asp:Label ID="lblPortalSharing" runat="server" Text="Cross portal sharing" resourcekey="lblPortalSharing"></asp:Label></h1>
	</div>
							...
							<asp:Panel runat="server" ID="pnlAddToCatsManualSelection" Style="display: none;"
								...
								<p>
									<asp:LinkButton ID="lbPortalsToShareTo" runat="server" CssClass="permissions_show_selection_dialog"
										Text="Select portals" resourcekey="lbPortalsToShareToResource1" />
								</p>
