										...
										<td>
														...
														<ItemTemplate>
															<table width="100%">
																<tr>
																	...
																	<td align="right">
																		<asp:CheckBox ID="cbApproved" runat="server" Checked='<%# Convert.ToBoolean(GetApproved(Eval("PictureID"))) %>'
																			resourcekey="cbApprovedResource1"></asp:CheckBox></td>
																</tr>
															</table>
														</ItemTemplate>
											...
											<table cellpadding="2" cellspacing="2" align="center">
												<tr>
													...
													<td>&nbsp;<asp:DropDownList ID="ddlImagesPerPage" runat="server" AutoPostBack="True"
