...
var controller=$.event._dpCache[this._dpId];controller.init(s);if(!alreadyExists&&s.createButton){controller.button=$('<a href="#" class="dp-choose-date" title="'+$.dpText.TEXT_CHOOSE_DATE+'">'+'<img src="../Images/Calender.jpg" width="22" height="17"  border="0" alt="'+$.dpText.TEXT_CHOOSE_DATE+'" />'+'</a>').bind('click',function()
