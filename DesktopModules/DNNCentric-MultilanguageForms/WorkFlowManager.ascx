<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowManager.ascx.cs" Inherits="DNNCentric.MultilanguageForms.WorkFlowManager" %>
                ...
                <Columns>
                 <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                   ...
                   <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                      <ItemTemplate>
                       <asp:ImageButton ID="imgSMTPSetting" runat="server" ResourceKey="imgSMTPSetting.Text" ImageUrl='<%# Common.GetImagePath("SettingsIcon.png")%>' OnClick="lnkSMTPSetting_Click" 
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Active" ItemStyle-HorizontalAlign="Left" HeaderStyle-ForeColor="White">
                      ...
                      <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:ImageButton ID="imgUp" runat="server" resourcekey="imgMoveUp.Text" OnClick="lnkUp_Click"
                                ImageUrl='<%# Common.GetImagePath("icon_arrow_up.gif")%>' CommandArgument='<%# Eval("WorkFlowID") %>' />
                        
                            <asp:HiddenField ID="hdnId" runat="server" Value='<%# Eval("WorkFlowID") %>' />
                 ...
                 <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="imgDown" runat="server" resourcekey="imgMoveDown.Text" OnClick="lnkDown_Click"
                                ImageUrl='<%# Common.GetImagePath("down.gif")%>' CommandArgument='<%# Eval("WorkFlowID") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
