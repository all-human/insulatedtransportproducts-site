<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CtrlCheckBoxList.ascx.cs" Inherits="DNNCentric.MultilanguageForms.Controls.CtrlCheckBoxList" %>
...
<tr><td colspan="2">&nbsp;</td></tr> 
    ...
    <tr>
     ...
     <tr>
        <td>
            <asp:Label ID="lblRepeatDirectionText" runat="server" resourcekey="lblRepeatDirectionText.Text" CssClass="CF_Admin_NormalText"></asp:Label>
        </td>
        <td>
    ...
    <tr>
        <td >
            <asp:Label ID="lblRepeatCloumnsTxt" runat="server" resourcekey="lblRepeatCloumnsTxt.Text" CssClass="CF_Admin_NormalText"></asp:Label>
        </td>
        <td>
    ...
    <tr>
       <td valign="top">
            <asp:Label ID="lblMaxAllowedSel" runat="server" resourcekey="lblMaxAllowedSel.Text" CssClass="CF_Admin_NormalText"></asp:Label>
        </td>
        <td valign="top">
            <asp:TextBox ID="txtMaxAllowedSel" MaxLength="3" runat="server" Width="71px" CssClass="CFC_NormalTextBox"></asp:TextBox>&nbsp;<asp:Label ID="lblMaxAllowedSelHelp" runat="server" resourcekey="lblMaxAllowedSelHelp.Text" CssClass="CF_Admin_NormalText"></asp:Label>
            
            <br /><asp:RangeValidator Type="Integer" Font-Size="Smaller" ID="rvMaxAllowedSel" CssClass="NormalRed"
             runat="server" MaximumValue="9999" MinimumValue="1" ControlToValidate="txtMaxAllowedSel" ErrorMessage="Enter numeric value" ></asp:RangeValidator> 
        </td>
    </tr>
    <tr><td colspan="2">&nbsp;</td></tr>
     <tr align="left">
...
<tr>
<td colspan="2">
    <asp:DataList ID="dlstChkBxList" Width="100%" runat="server" BackColor="White" BorderWidth="0px"
        ...
        <ItemTemplate>
             ...
             <tr>
              ...
              <tr>
                 ...
                 <td>
                 <asp:TextBox ID="txtOptionlist" runat="server" TextMode="MultiLine" CssClass="CFC_NormalTextBox" Text="<%# ((mlContent)Container.DataItem).Options %>" Width="100%" Height="80px"></asp:TextBox>
                  <br/>
             ...
             <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDefault" runat="server" Text="<%# ((mlContent)Container.DataItem).DefaultValue %>" CssClass="CFC_NormalTextBox" Width="100%"></asp:TextBox>
