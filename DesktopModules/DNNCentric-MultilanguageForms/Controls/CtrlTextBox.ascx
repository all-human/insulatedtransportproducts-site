<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CtrlTextBox.ascx.cs"
    Inherits="DNNCentric.MultilanguageForms.Controls.CtrlTextBox" %>
...
<table style="background-color: White" width="100%" >
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlTextMode" runat="server" OnSelectedIndexChanged="ddlTextMode_SelectedIndexChanged"
                AutoPostBack="true" CssClass="CFC_NormalTextBox">
                <asp:ListItem Value="1">Single Line</asp:ListItem>
                <asp:ListItem Value="2">Multi Line</asp:ListItem>
            </asp:DropDownList>
            <asp:TextBox ID="txtNoOfRows" MaxLength="3" runat="server" Width="30px" CssClass="CFC_NormalTextBox"></asp:TextBox><asp:Label
                ID="lblNumOfRows" CssClass="CF_Admin_NormalText" runat="server" resourcekey="lblNumOfRows.Text"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtWidth" runat="server" Width="71px" CssClass="CFC_NormalTextBox"></asp:TextBox>&nbsp;<asp:Label
                ID="lblPix" runat="server" resourcekey="PixWidth.Text" CssClass="CF_Admin_NormalText"></asp:Label>
        </td>
    </tr>
    <tr id="trMaxLength" runat="server">
        <td>
            <asp:Label ID="lblMaxLength" MaxLength="3" runat="server" resourcekey="lblMaxLength.Text"
    ...
    <tr>
        <td>
            <asp:Label ID="lblValidationType" runat="server" resourcekey="lblValidationType.Text"
                CssClass="CF_Admin_NormalText"></asp:Label>
        </td>
        <td>
            ...
            <asp:TextBox ID="txtenterregularexpression" style="display:none;" runat="server" CssClass="CFC_NormalTextBox"></asp:TextBox>
        </td>
    ...
    <tr align="left">
        <td colspan="2">
            <asp:DataList ID="dlstTextBox" runat="server" Width="100%" BackColor="White" BorderWidth="0px"
                ...
                <ItemTemplate>
                    <table id="tblML" runat="server" width="99%">
                        ...
                        <tr>
                            <td>
                                <%--<asp:Label ID="lblDefault" runat="server" Text='<%#string.Format("{0} ({1})","Default Value",((mlContent)Container.DataItem).Culture) %>' CssClass="CF_Admin_NormalText"></asp:Label>--%>
