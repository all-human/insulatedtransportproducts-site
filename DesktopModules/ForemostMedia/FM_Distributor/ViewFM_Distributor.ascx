<%@ Control Language="C#" EnableViewState="false" Inherits="ForemostMedia.Modules.FM_Distributor.ViewFM_Distributor"
    AutoEventWireup="true" CodeBehind="ViewFM_Distributor.ascx.cs" %>
<%@ Register TagPrefix="cc1" Namespace="DotNetNuke.UI.WebControls" Assembly="DotNetNuke" %>

<div class="fmStyle container">
