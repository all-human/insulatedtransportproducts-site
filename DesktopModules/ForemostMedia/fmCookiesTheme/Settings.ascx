<%@ Control Language="C#" AutoEventWireup="false" Inherits="ForemostMedia.Modules.fmCookiesTheme.Settings" Codebehind="Settings.ascx.cs" %>
        ...
        <div class="dnnForm" id="fmExternalLibraries">
            ...
            <div id="TwitterBootstrap">
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:TextBox ID="tbTwitterBootstrapCdnUrl" CssClass="NormalTextBox" runat="server" /><br />
                </div>
                <div class="dnnFormItem">
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:TextBox ID="tbTwitterBootstrapJsCdn" CssClass="NormalTextBox" runat="server" /><br />
                </div>
            </div>
            <div id="FontAwesome">
                <div class="dnnFormItem">
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:TextBox ID="tbFontAwesomeCdn" CssClass="NormalTextBox" runat="server" /><br />
                </div>
            </div>
        </div>
    </fieldset>
