...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="AddVideo.ascx.vb" Inherits="BizModules.UltraVideoGallery.DNN6.AddVideoDNN6" %>
        ...
        <td class="dnnupload twocolleft">
            <asp:Panel ID="pnlUpload" runat="server" CssClass="uploadsection way_upload">
                ...
                <div class="upload">
                    ...
                    <cc1:DnnUpload ID="DnnUpload1" runat="server" ControlObjectsVisibility="AddButton, RemoveButtons" InputSize="40" MaxFileSize="2147483647">
                    </cc1:DnnUpload>        
